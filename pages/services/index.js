...
const Services = () => {
  return ( 
    <div className='h-full bg-slate-950 text-slate-100 py-36 flex items-center relative overflow-hidden'>
      {/* Background minimalist grid and radial spots */}
      ...
      <div className='absolute top-[20%] left-[-10%] h-[600px] w-[600px] rounded-full bg-indigo-500/5 blur-[130px] pointer-events-none'></div>
      ...
      <div className='container mx-auto relative z-10'>
        <div className='flex flex-col xl:flex-row gap-x-12 items-center xl:items-start'>
          ...
          <div className='text-center flex xl:w-[35vw] flex-col xl:text-left mb-12 xl:mb-0 px-4 xl:px-0'>
            ...
            >
              My Services <span className='text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400'>.</span>
            </motion.h2>
          ...
          {/* slider */}
          <motion.div
            variants={fadeIn('left', 0.6)} initial='hidden' animate='show' exit='hidden'
